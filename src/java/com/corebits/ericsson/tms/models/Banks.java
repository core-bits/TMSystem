...
@NamedQueries({
    ...
    @NamedQuery(name = "Banks.findByStatus", query = "SELECT b FROM Banks b WHERE b.status = :status")})
public class Banks implements Serializable {
    ...
    public Banks(String id, String name, boolean status) {
        this.id = id;
        this.name = name;
        this.status = status;
    }
    ...
    public String toString() {
        return "com.corebits.ericsson.models.Banks[ id=" + id + " ]";
    }
